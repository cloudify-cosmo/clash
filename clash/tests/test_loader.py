...
class TestLoader(tests.BaseTest):
    ...
    def test_properties(self):
        ...
        self.assertEqual(loader.config.config, config1)
        self.assertEqual(loader.config.blueprint_path, expected_blueprint_path)
        self.assertEqual(loader.config.blueprint_dir, expected_blueprint_dir)
